...
const ElectricalForm = () => {
  const [data, setData] = useState({
    ...
    availabilityTime: "",
    contactInfo: "",
    serviceType: "ElectricalForm", // auto-filled
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("ElectricalForm service request submitted!");
      setData({
        name: "",
        address: "",
        availabilityTime: "",
        contactInfo: "",
        serviceType: "ElectricalForm",
      });
    } catch (error) {
      alert(
    ...
    >
      ...
      >
        <h2 className="text-3xl font-bold text-center mb-6 text-blue-700">
          ElectricalForm   Service Request
        </h2>
