...
const PaintingForm = () => {
  const [data, setData] = useState({
    ...
    availabilityTime: "",
    contactInfo: "",
    serviceType: "PaintingForm", // auto-filled
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("PaintingForm service request submitted!");
      setData({
        name: "",
        address: "",
        availabilityTime: "",
        contactInfo: "",
        serviceType: "PaintingForm",
      });
    } catch (error) {
      alert(
